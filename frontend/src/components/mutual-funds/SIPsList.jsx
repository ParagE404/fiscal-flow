      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center h-32 space-y-2">
            ...
            <div className="text-sm text-muted-foreground">Add your first SIP to get started</div>
          </div>
        </CardContent>
      </Card>
    )
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <SortableHeader field="nextDueDate">Next Due Date</SortableHeader>
                <SortableHeader field="totalInstallments">Installments</SortableHeader>
            ...
            <TableBody>
              {sortedSIPs.map((sip) => {
                const progress = sip.totalInstallments > 0 
                ...
                return (
                  <TableRow key={sip.id} className="hover:bg-muted/50">
                    ...
                    <TableCell>
                      <div className="space-y-1">
                        <div>{sip.completedInstallments || 0} / {sip.totalInstallments || 0}</div>
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-2">
                        <Badge variant={getStatusVariant(sip.status)} className="flex items-center space-x-1">
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete the SIP for "{deletingSIP?.fundName}"? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
